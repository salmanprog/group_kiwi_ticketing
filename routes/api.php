...
use App\Http\Controllers\Api\UserContractModifiedController;
...
Route::middleware([ApiAuthorization::class])->group(function(){
    ...
    Route::middleware(['custom_auth:api'])->group(function(){
        ...
        Route::post('update-order-invoice',[UserEstimateController::class,'updateInvoice'])->name('api.update-invoice');
        ...
        Route::resource('client-contract-modified',UserContractModifiedController::class)->except(['create','delete','index']);
        ...
        Route::post('send-ticket-email',[UserContractController::class,'sendTicketEmail'])->name('api.send-ticket-email');
