...
class Company extends Model
{
     ...
     */
    protected $fillable = [
        'id','login_url', 'auth_code', 'name','slug', 'image_url', 'address','address_2', 'city', 'state', 'zip', 'country', 'mobile_no', 'email', 'website', 'description', 'status', 'created_at', 'updated_at', 'deleted_at'
    ];
    /**
