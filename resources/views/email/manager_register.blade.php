...
<body>
    <div class="header">
        <h1>{{$company_name}} Added You to Their Groups Portal as Manager</h1>
    </div>
    
    <div class="content">
        <p>Dear {{$username}}</p>
        
        <p>Your company email account has been created and {{$company_name}} has added you to their Groups Portal as Manager. Please find your login details below:</p>
