                    ...
                    <div class="card-header card-default">
                        <div class="row">
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <a class="btn btn-info pull-right" href="{{ route('manager-management.create') }}">Add New Manager</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-header">
                        <div class="header-content">
                            <div class="header-title">
                                ...
                                <h3>Manager Listing</h3>
                                <span class="badge-count">Total Managers: <span id="total-count">0</span></span>
                            </div>
                            <div class="header-actions">
                                @if (Auth::user()->user_type != 'admin' && Auth::user()->user_type != 'client')
                                    <a class="btn btn-primary" href="{{ route('manager-management.create') }}">
                                        <i class="fas fa-plus-circle"></i> Add New Manager
                                    </a>
                                @endif
                            </div>
                        </div>
