            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="container mt-4">
                        <form method="post" action="{{ route('manager-management.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <!-- Admin Details Card SECOND -->
                            <div class="card">
                ...
                <div class="card">
                    <div class="card-header custfor-flex-header">
                        ...
                        <div class="header-actions">
                            <a href="{{ route('manager-management.index') }}" class="btn btn-outline">
                                <i class="fas fa-arrow-left"></i> Back to List
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('manager-management.store') }}" enctype="multipart/form-data" class="manager-form">
                            {{ csrf_field() }}
                            <input type="hidden" name="user_type" value="admin">
                            <input type="hidden" name="user_group_id" value="2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="name" value="{{ old('name') }}" 
                                                   class="form-control" placeholder="Enter manager's full name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="email" name="email" value="{{ old('email') }}" 
                                                   class="form-control" placeholder="manager@example.com">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="name" value="{{ old('name',$record->name) }}"
                                                class="form-control" placeholder="Enter manager's full name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="email" name="email" value="{{ old('email',$record->email) }}"
                                                class="form-control" placeholder="manager@example.com" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="mobile_no" value="{{ old('mobile_no',$record->mobile_no) }}"
                                                class="form-control" placeholder="+92-3001234567"
                                                pattern="^\+?\d{1,3}-\d{9,11}$" readonly>
                                            <small class="form-hint">Format: +CountryCode-Number</small>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
