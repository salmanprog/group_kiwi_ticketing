...
@section('content')
                    ...
                    <div class="card-header card-default">
                        <div class="row">
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <a class="btn btn-info pull-right" href="{{ route('client-management.create') }}">Add New Contact</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    @push('scripts')
        <script>
            let ajax_listing_url  = `{{ route('client-management.ajax-listing') }}`;
        </script>
                    ...
                    <div class="card-header">
                        <div class="header-content">
                            <div class="header-title">
                                ...
                                <span class="badge-count">Total Clients: <span id="total-count">0</span></span>
                            </div>
                            <div class="header-actions">
                                @if (Auth::user()->user_type != 'admin' && Auth::user()->user_type != 'client')
                                    <a class="btn btn-primary" href="{{ route('client-management.create') }}">
                        ...
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    ...
                                    <span>Showing all clients</span>
                                </div>
                            </div>
                            <div class="controls-right">
                                <form id="search_form" method="GET" class="search-form">
                                    <div class="input-group">
                                        <input type="text" name="keyword" class="form-control" placeholder="Search Name,Email...">
                    ...
                    <div class="card-header">
                        <div class="header-content">
                            <div class="header-title">
                                ...
                                <span class="badge-count">Total Contact: <span id="total-count">0</span></span>
                            </div>
                            <div class="header-actions">
                                @if (Auth::user()->user_type != 'admin' && Auth::user()->user_type != 'client')
                                    <a class="btn btn-primary" href="{{ route('client-management.create') }}">
