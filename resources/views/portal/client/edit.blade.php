        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post"
                            action="{{ route('client-management.update', ['client_management' => $record->slug]) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="salutation" class="form-control" required>
                                                ...
                                                <option value="Mr" {{ $record->salutation == 'Mr' ? 'selected' : '' }}>
                                                    Mr</option>
                                                <option value="Mrs" {{ $record->salutation == 'Mrs' ? 'selected' : '' }}>
                                                    Mrs</option>
                                                <option value="Ms" {{ $record->salutation == 'Ms' ? 'selected' : '' }}>
                                                    Ms</option>
                                                <option value="Dr" {{ $record->salutation == 'Dr' ? 'selected' : '' }}>
                                                    Dr</option>
                                                <option value="Prof"{{ $record->salutation == 'Prof' ? 'selected' : '' }}>
                                                    Prof</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="abc" id="abc"
                                                value="{{ $organization ? $organization->name : 'N/A' }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="last_name"
                                                value="{{ $record->last_name }}" class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="contract_status" class="form-control">
                                                ...
                                                <option {{ $record->contract_status == 'called' ? 'selected' : '' }}
                                                    value="called">Called</option>
                                                <option {{ $record->contract_status == 'dead' ? 'selected' : '' }}
                                                    value="dead">Dead</option>
                                                <option {{ $record->contract_status == 'lead' ? 'selected' : '' }}
                                                    value="lead">Lead</option>
                                                <option {{ $record->contract_status == 'pending' ? 'selected' : '' }}
                                                    value="pending">Pending</option>
                                                <option
                                                    {{ $record->contract_status == 'tentative_date' ? 'selected' : '' }}
                                                    value="tentative_date">Tentative Date</option>
                                                <option
                                                    {{ $record->contract_status == 'loa_send_close' ? 'selected' : '' }}
                                                    value="loa_send_close">LOA Sent (Closed)</option>
                                                <option {{ $record->contract_status == 'loa_received' ? 'selected' : '' }}
                                                    value="loa_received">LOA Received</option>
                                                <option {{ $record->contract_status == 'gate_group' ? 'selected' : '' }}
                                                    value="gate_group">Gate Group</option>
                                            </select>
                                        </div>
                                    </div>
