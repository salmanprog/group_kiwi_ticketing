                ...
                <div class="card">
                    <div class="card-header card-default">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a class="btn btn-info pull-right" href="{{ route('product.create') }}">Add Product</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="_ajax_datatable" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fas fa-envelope"></i> Price</th>
                                        <th><i class="fas fa-phone"></i> Unit</th>
                    ...
                    <div class="card-header">
                        <div class="header-content">
                            <div class="header-title">
                                {{-- <i class="fas fa-user-friends"></i> --}}
                                <h3>Product Listing</h3>
                                <span class="badge-count">Total Products: <span id="total-count">0</span></span>
                            </div>
                            <div class="header-actions">
                                <a class="btn btn-primary" href="{{ route('product.create') }}">
                                    <i class="fas fa-plus-circle"></i> Add Product
                        ...
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    ...
                                    <form id="filter_form" method="GET" action="{{ route('product.index') }}"
                                        class="filter-form"
