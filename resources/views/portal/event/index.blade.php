            ...
            <div class="card">
                <div class="card-header card-default">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a class="btn btn-info pull-right" href="{{ route('event-type.create') }}">Add Event
                                Type</a>
                        </div>
                    </div>
                </div>
...
@push('scripts')
<script>
    let ajax_listing_url = `{{ route('event-type.ajax-listing') }}`;
</script>
                ...
                <div class="card-header">
                    <div class="header-content">
                        <div class="header-title">
                            ...
                            <h3>Event Type Listing</h3>
                        </div>
                        <div class="header-actions">
                            <a class="btn btn-primary" href="{{ route('event-type.create') }}">
                                <i class="fas fa-plus-circle"></i> Add Event Type
                            </a>
                        </div>
                    </div>
                </div>
