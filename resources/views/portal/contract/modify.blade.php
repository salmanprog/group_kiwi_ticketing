                ...
                <div class="estimate-wrapper">
                    ...
                    <div class="estimate-header">
                        <div class="estimate-title">
                            <i class="fas fa-file-invoice-dollar me-2"></i>Modify Contract {{$contract->slug}}
                        </div>
                    </div>
                    {{-- Form Start --}}

                      <form method="POST" action="{{ route('contract.modify') }}" id="update-estimate-form">
                            ...
                            <div class="form-row mt-4">
                                <div class="col-12">
                                    ...
                                    <div class="mt-4 pt-3 border-top">
                                        <label class="form-label font-weight-bold">Do you need ask approval for client ?</label>
    ...
    <script>
     ...
     function addSelectedProducts() {
            ...
            checkboxes.forEach((checkbox) => {
                ...
                const row = document.createElement("tr");
                row.innerHTML = `
                    <input type="hidden" name="products[${productIndex}][id]" class="form-control" value="${id}" readonly>
