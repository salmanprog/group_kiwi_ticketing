...
@section('content')
                    ...
                    <div class="card-header">
                        <div class="header-content">
                            <div class="header-title">
                                ...
                                <span class="badge-count">Total Contracts: <span id="total-count">0</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                       <div class="table-controls">
                                        ...
                                        <div class="status-filter-group">
                                            ...
                                            <select id="status" name="status" class="status-select">
                                                ...
                                                <option value="accepted"
                                                    {{ request('status') == 'accepted' ? 'selected' : '' }}>Accepted
                                                </option>
                            ...
                            <div class="controls-right">
                                <form id="search_form" method="GET" class="search-form">
                                    <div class="input-group">
                                        <input type="text" name="keyword" class="form-control" placeholder="Search contracts...">
                        ...
                        <div class="table-responsive">
                            <table id="_ajax_datatable" class="table">
                                <thead>
                                    <tr>
                                        <th><i class="fas fa-hashtag"></i> Contract No</th>
                                        <th><i class="fas fa-calendar-day"></i> Company Name</th>
                                        <th><i class="fas fa-circle"></i> Total</th>
                                        <th><i class="fas fa-calendar"></i> Status</th>
                                        <th><i class="fas fa-cog"></i> Created At</th>
                                        <th><i class="fas fa-cog"></i> Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <!-- Data load hoga via AJAX -->
                                </tbody>
                            </table>
                        </div>
                    </div>
    ...
    @push('scripts')
        <script>
            let ajax_listing_url  = `{{ route('contract.ajax-listing') }}`;
        </script>
