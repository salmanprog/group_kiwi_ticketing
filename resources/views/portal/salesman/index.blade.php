                    ...
                    <div class="card-header card-default">
                        <div class="row">
                            ...
                            @if(Auth::user()->user_type !='admin' && Auth::user()->user_type !='client')
                                <div class="col-md-6">
                                    <a class="btn btn-info pull-right" href="{{ route('salesman-management.create') }}">Add New Salesman</a>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="card-header">
                        <div class="header-content">
                            <div class="header-title">
                                ...
                                <h3>Salesman Listing</h3>
                                <span class="badge-count">Total Salesmen: <span id="total-count">0</span></span>
                            </div>
                            <div class="header-actions">
                                @if(Auth::user()->user_type !='admin' && Auth::user()->user_type !='client')
                                <a class="btn btn-primary" href="{{ route('salesman-management.create') }}">
                                    <i class="fas fa-plus-circle"></i> Add New Salesman
                                </a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    ...
                                    <span>Showing all salesmen</span>
                            ...
                            <div class="controls-right">
                                <form id="search_form" method="GET" class="search-form">
                                    <div class="input-group">
                                        <input type="text" name="keyword" class="form-control" placeholder="Search salesmen...">
                        ...
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    ...
                                    <form id="filter_form" method="GET" action="{{ route('salesman-management.index') }}"
                                        class="filter-form"
                                        style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
