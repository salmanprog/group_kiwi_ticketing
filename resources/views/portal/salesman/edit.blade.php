                         ...
                         <form method="post"
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="email" name="email" value="{{ old('email',$record->email) }}"
                                                class="form-control" placeholder="salesman@example.com" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="statusSelect">Update User Status</label>
                                            ...
                                            <div class="form-text">
                                                Changing status will immediately affect user's access to the system.
                                            </div>
                                        </div>
                                    </div>
                                </div>
