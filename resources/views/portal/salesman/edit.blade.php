                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="header-content">
                                <h3>Edit Salesman Status</h3>
                            </div>
                            {{-- <div class="header-actions">
                                <a href="{{ route('manager-management.index') }}" class="btn-outline">
                                    Back to List
                                </a>
                            </div> --}}
                        </div>
                        <div class="card-body">
                            ...
                            <div class="user-info">
                                ...
                                <div class="user-details">
                                    ...
                                    <div class="user-detail-item">
                                        <span class="user-detail-label">Mobile Number</span>
                                        <span class="user-detail-value">{{ $record->mobile_no ?? 'Not provided' }}</span>
                                    </div>
                                    <div class="user-detail-item">
