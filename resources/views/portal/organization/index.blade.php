                        ...
                        <table id="_ajax_datatable" class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><i class="fas fa-user"></i> Organization Type</th>
                                    <th><i class="fas fa-envelope"></i> Event Type</th>
                                    <th><i class="fas fa-phone"></i> Status</th>
                                    <th><i class="fas fa-calendar"></i> Created At</th>
                                    @if(Auth::user()->user_type == 'company' || Auth::user()->user_type == 'salesman' ||
