...
@section('content')
                    ...
                    <div class="card-header card-default">
                        <div class="row">
                            ...
                            @if (Auth::user()->user_type != 'admin' && Auth::user()->user_type != 'client')
                                <div class="col-md-7">
                                    <a class="btn btn-info pull-right" href="{{ route('company-management.create') }}">Add New Company</a>
                                </div>
                            @endif
                        </div>
                    </div>
    ...
    @push('scripts')
        <script>
            let ajax_listing_url = '{!! route("company-management.ajax-listing") !!}';
        </script>
                        ...
                        <div class="header-content">
                            ...
                            <div class="header-actions">
                                @if (Auth::user()->user_type == 'admin')
                                    <a class="btn btn-primary" href="{{ route('company-management.create') }}">
                        ...
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    ...
                                    <span>Showing all managers</span>
                        ...
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    ...
                                    <form id="filter_form" method="GET" action="{{ route('company-management.index') }}"
                                        class="filter-form"
                                        style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
