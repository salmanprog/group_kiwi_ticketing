        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('company-management.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="email" value="{{ old('company_email') }}"
                                                name="company_email" class="form-control" placeholder="company@example.com">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="company_mobile_no"
                                                value="{{ old('company_mobile_no') }}" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="company_website"
                                                value="{{ old('company_website') }}" class="form-control"
