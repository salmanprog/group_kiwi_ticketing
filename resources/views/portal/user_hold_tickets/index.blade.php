...
@section('content')
                    ...
                    <div class="card-header">
                        <div class="header-content">
                            <div class="header-title">
                                ...
                                <h3>Hold Tickets Listing</h3>
                            </div>
                            <div class="header-actions">
                                <a class="btn btn-primary" href="{{ route('hold-tickets.create') }}">
                                    <i class="fas fa-plus-circle"></i> Add Hold Ticket
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    @push('scripts')
        <script>
            let ajax_listing_url = `{{ route('hold-tickets.ajax-listing') }}`;
        </script>
