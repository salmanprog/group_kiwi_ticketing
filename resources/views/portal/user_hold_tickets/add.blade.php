                ...
                <div class="card">
                    <div class="card-header custfor-flex-header">
                        <div class="header-content">
                            <h3>Create New User Hold Tickets</h3>
                        </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('hold-tickets.store') }}" class="estimate-form">
                            {{ csrf_field() }}
                            <div class="form-section">
                                <div class="section-header">
                                    <h5>User Hold Tickets Details</h5>
                                                ...
                                                <select name="estimate_id" class="form-control select2" required>
                                                        ...
                                                        @foreach ($Estimates as $Estimate)
                                                            <option value="{{ $Estimate->id }}"
                                                                {{ $Estimate->id == old('estimate_id') ? 'selected' : '' }}>
                                                                {{ $Estimate->slug }}
                                                            </option>
                                                        @endforeach
                                                    </select>
