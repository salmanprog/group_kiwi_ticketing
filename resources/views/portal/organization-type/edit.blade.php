        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('organization-type.update',['organization_type' => $record->slug]) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                ...
                <div class="card">
                    <div class="card-header custfor-flex-header">
                        ...
                        <div class="header-actions">
                            <a href="{{ route('organization-type.index') }}" class="btn btn-outline">
