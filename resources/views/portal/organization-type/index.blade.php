            ...
            <div class="card">
                <div class="card-header card-default">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a class="btn btn-info pull-right" href="{{ route('organization-type.create') }}">Add
                                Account Type</a>
                        </div>
                    </div>
                </div>
...
@push('scripts')
<script>
    let ajax_listing_url = `{{ route('organization-type.ajax-listing') }}`;
</script>
                ...
                <div class="card-header">
                    <div class="header-content">
                        <div class="header-title">
                            ...
                            <h3>Account Type Listing</h3>
                        </div>
                        <div class="header-actions">
                            <a class="btn btn-primary" href="{{ route('organization-type.create') }}">
                                <i class="fas fa-plus-circle"></i> Add Account Type
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    {{-- <i class="fas fa-database"></i>
                                    <span>Showing all Organization</span> --}}

                                    <form id="filter_form" method="GET" action="{{ route('organization-type.index') }}"
                                        class="filter-form"
