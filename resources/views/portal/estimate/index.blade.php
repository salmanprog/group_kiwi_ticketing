...
@section('content')
                    ...
                    <div class="card-header card-default"> 
                        <div class="row">
                            ...
                            @if (Auth::user()->user_type != 'client')
                                <a class="btn btn-info pull-right" href="{{ route('estimate.create') }}">Create Estimate</a>
                            @endif
                            </div>
                        </div>
                    </div>
    ...
    @push('scripts')
        <script>
            let ajax_listing_url  = `{{ route('estimate.ajax-listing') }}`;
        </script>
                    ...
                    <div class="card-header">
                        <div class="header-content">
                            <div class="header-title">
                                ...
                                <h3>Estimate Listing</h3>
                                <span class="badge-count">Total Estimates: <span id="total-count">0</span></span>
                            </div>
                            <div class="header-actions">
                                @if (Auth::user()->user_type != 'client')
                                    <a class="btn btn-primary" href="{{ route('estimate.create') }}">
                        ...
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    ...
                                    <span>Showing all estimates</span>
                                    <form id="filter_form" method="GET" action="{{ route('manager-management.index') }}"
                                        class="filter-form"
                                        ...
                                        <div class="status-filter-group">
                                            ...
                                            <select id="status" name="status" class="status-select">
                                                ...
                                                @if (Auth::user()->user_type == 'client')
                                                <option value="new"
                                                    {{ request('status') == 'new' ? 'selected' : '' }}>New
                                                </option>
                                                @endif
                                                ...
                                                <option value="revised"
                                                    {{ request('status') == 'revised' ? 'selected' : '' }}>Revised
                                                </option>
                            ...
                            <div class="controls-right">
                                <form id="search_form" method="GET" class="search-form">
                                    <div class="input-group">
                                        <input type="text" name="keyword" class="form-control" placeholder="Search estimates...">
                            ...
                            <table id="_ajax_datatable" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fas fa-hashtag"></i> Estimate No</th>
                                        <th><i class="fas fa-calendar-day"></i> Estimate Date</th>
    ...
    @endpush
     ...
     <style>
        ...
        .table-info {
            ...
            border-radius: 12px;
            box-shadow: 0 4px 12px rgba(138, 185, 51, 0.15);
        }
        ...
        .filter-form {
            ...
            padding: 10px 20px;
            border-radius: 12px;
            box-shadow: 0 4px 15px rgba(160, 194, 66, 0.15);
        }
