...
@section('content')
    ...
    @push('scripts')
        <script>
            let ajax_listing_url  = `{{ route('invoice.ajax-listing') }}`;
        </script>
                    ...
                    <div class="card-header">
                        <div class="header-content">
                            <div class="header-title">
                                ...
                                <span class="badge-count">Total Invoices: <span id="total-count">0</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    ...
                                    <span>Showing all invoices</span>
                            ...
                            <div class="controls-right">
                                <form id="search_form" method="GET" class="search-form">
                                    <div class="input-group">
                                        <input type="text" name="keyword" class="form-control" placeholder="Search Invoices...">
                        ...
                        <div class="table-responsive">
                            <table id="_ajax_datatable" class="table">
                                <thead>
                                    <tr>
                                        <th><i class="fas fa-hashtag"></i> Invoice No</th>
                        ...
                        <div class="table-controls">
                            <div class="controls-left">
                                <div class="table-info">
                                    ...
                                    <form id="filter_form" method="GET" action="{{ route('invoice.index') }}"
                                        class="filter-form"
                                        style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
